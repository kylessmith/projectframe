...
# Call setup()
#########################################################
package_list = ['projectframe',
                'projectframe.core',
                'projectframe.objects',
                'projectframe.engines']
package_dirs = {'projectframe': 'projectframe',
                'projectframe.core': 'projectframe/core',
                'projectframe.objects': 'projectframe/objects',
                'projectframe.engines': 'projectframe/engines'}
...
setup(
    ...
    url = "https://github.com/kylessmtih/projectframe",
    ...
    setup_requires = ["ailist","intervalframe","numpy","pandas","h5py"],
    install_requires = ["ailist","intervalframe","numpy","pandas","h5py"],
    provides = ["projectframe"],
    keywords = ["interval pandas dataframe ailist overlap"],
    packages = find_packages(),
    package_data={'projectframe': ['*.pxd', '*.pyx', '*.c', '*.h']},
    # Disable zip_safe
    zip_safe = False,
